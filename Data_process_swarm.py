...
class RealTimeProcessor(object):
    ...
    def data_unpack(self, udp_data): ## qns abt this
        ...
        # 2 seems to work better than 0.001
        self.quat_x1_filted = float(qx1)*0.001
        self.quat_y1_filted = float(qy1)*0.001
        self.quat_z1_filted = float(qz1)*0.001
        self.quat_w1_filted = float(qw1)*0.001
