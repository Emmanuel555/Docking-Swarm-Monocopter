...
if __name__ == '__main__':        
    ...
    while True:
        ...
        #if count % 0.3 == 0:
        print(f"Thrust: {manual_thrust}, X: {a0}, Y: {a1}, Enable: {enable}, Button0: {button0}, Button1: {button1}, Button2: {button2}, ConPad: {conPad}, Current direction: {current_direction}")     
