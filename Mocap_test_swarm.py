...
if __name__ == '__main__':
    ...
    try:
        ...
        while True:  
            ...
            data_processor_1.data_unpack_filtered(data,1)
            data_processor_2.data_unpack_filtered(data,2)

            # cartesian position
            pos_1 = data_processor_1.filted_data
            pos_2 = data_processor_2.filted_data
            ...
            if count % 5 == 0:
                ...
                print("position_long: ", pos_1[0:3])
                print("position_short: ", pos_2[0:3])
